...
INSERT IGNORE INTO movies (id, title, director, release_year, duration_min, rating, genre, description) VALUES
(1,  'Dick Johnson Is Dead',                                          'Kirsten Johnson',                                    2020, 90,  'PG-13', 'Documentaries',                                        'As her father nears the end of his life, filmmaker Kirsten Johnson stages his death in inventive and comical ways to help them both face the inevitable.'),
...
(3,  'Sankofa',                                                       'Haile Gerima',                                       1993, 125, 'TV-MA', 'Dramas, Independent Movies, International Movies',    'On a photo shoot in Ghana, an American model slips back in time, becomes enslaved on a plantation and bears witness to the agony of her ancestral past.'),
(4,  'The Starling',                                                  'Theodore Melfi',                                     2021, 104, 'PG-13', 'Comedies, Dramas',                                    'A woman adjusting to life after a loss contends with a feisty bird that''s taken over her garden — and a husband who''s struggling to find a way forward.'),
(5,  'Je Suis Karl',                                                  'Christian Schwochow',                                2021, 127, 'TV-MA', 'Dramas, International Movies',                        'After most of her family is murdered in a terrorist bombing, a young woman is unknowingly lured into joining the very group that killed them.'),
...
(11, 'Jeans',                                                         'S. Shankar',                                         1998, 166, 'TV-14', 'Comedies, International Movies, Romantic Movies',     'When the father of the man she loves insists that his twin sons marry twin sisters, a woman creates an alter ego that might be a bit too convincing.'),
...
(13, 'Grown Ups',                                                     'Dennis Dugan',                                       2010, 103, 'PG-13', 'Comedies',                                            'Mourning the loss of their beloved junior high basketball coach, five middle-aged pals reunite at a lake house and rediscover the joys of being a kid.'),
(14, 'Dark Skies',                                                    'Scott Stewart',                                      2013, 97,  'PG-13', 'Horror Movies, Sci-Fi & Fantasy',                     'A family''s idyllic suburban life shatters when an alien force invades their home, and as they struggle to convince others of the deadly threat.'),
(15, 'Paranoia',                                                      'Robert Luketic',                                     2013, 106, 'PG-13', 'Thrillers',                                           'Blackmailed by his company''s CEO, a low-level employee finds himself forced to spy on the boss''s rival and former mentor.'),
